...
[![Build Status](https://builds.gbif.org/job/hp-africamuseum/badge/icon)](https://builds.gbif.org/job/hp-africamuseum/lastBuild/console)
...
# GBIF Hosted Portal: africamuseum

This Jekyll website, **[africamuseum (Staging)](https://africamuseum.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
